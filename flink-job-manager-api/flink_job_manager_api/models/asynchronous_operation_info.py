...
T = TypeVar("T", bound="AsynchronousOperationInfo")
...
class AsynchronousOperationInfo:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if failure_cause is not UNSET:
            field_dict["failure-cause"] = failure_cause
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        _failure_cause = d.pop("failure-cause", UNSET)
        failure_cause: Union[Unset, SerializedThrowable]
        ...
        asynchronous_operation_info = cls(
            failure_cause=failure_cause,
        )

        asynchronous_operation_info.additional_properties = d
        return asynchronous_operation_info
