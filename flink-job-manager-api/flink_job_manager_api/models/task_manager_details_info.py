...
if TYPE_CHECKING:
    ...
    from ..models.task_manager_metrics_info import TaskManagerMetricsInfo


T = TypeVar("T", bound="TaskManagerDetailsInfo")
...
class TaskManagerDetailsInfo:
    """
    Attributes:
        allocated_slots (Union[Unset, list['SlotInfo']]):
        ...
        metrics (Union[Unset, TaskManagerMetricsInfo]):
    ...
    allocated_slots: Union[Unset, list["SlotInfo"]] = UNSET
    ...
    metrics: Union[Unset, "TaskManagerMetricsInfo"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        allocated_slots: Union[Unset, list[dict[str, Any]]] = UNSET
        if not isinstance(self.allocated_slots, Unset):
            allocated_slots = []
            for allocated_slots_item_data in self.allocated_slots:
                allocated_slots_item = allocated_slots_item_data.to_dict()
                allocated_slots.append(allocated_slots_item)
        ...
        field_dict.update({})
        if allocated_slots is not UNSET:
            field_dict["allocatedSlots"] = allocated_slots
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        allocated_slots = []
        _allocated_slots = d.pop("allocatedSlots", UNSET)
        for allocated_slots_item_data in _allocated_slots or []:
            allocated_slots_item = SlotInfo.from_dict(allocated_slots_item_data)
        ...
        if isinstance(_metrics, Unset):
            ...
            metrics = TaskManagerMetricsInfo.from_dict(_metrics)
        ...
        task_manager_details_info.additional_properties = d
        return task_manager_details_info
