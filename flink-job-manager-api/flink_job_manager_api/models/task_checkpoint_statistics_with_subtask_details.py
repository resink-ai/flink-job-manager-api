...
if TYPE_CHECKING:
    from ..models.subtask_checkpoint_statistics import SubtaskCheckpointStatistics
    from ..models.task_checkpoint_statistics_with_subtask_details_summary import (
        TaskCheckpointStatisticsWithSubtaskDetailsSummary,
    )


T = TypeVar("T", bound="TaskCheckpointStatisticsWithSubtaskDetails")
...
class TaskCheckpointStatisticsWithSubtaskDetails:
    ...
    Attributes:
        ...
        subtasks (Union[Unset, list['SubtaskCheckpointStatistics']]):
        summary (Union[Unset, TaskCheckpointStatisticsWithSubtaskDetailsSummary]):
    """
    ...
    subtasks: Union[Unset, list["SubtaskCheckpointStatistics"]] = UNSET
    summary: Union[Unset, "TaskCheckpointStatisticsWithSubtaskDetailsSummary"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for subtasks_item_data in _subtasks or []:
            subtasks_item = SubtaskCheckpointStatistics.from_dict(subtasks_item_data)
        ...
        if isinstance(_summary, Unset):
            ...
            summary = TaskCheckpointStatisticsWithSubtaskDetailsSummary.from_dict(_summary)

        task_checkpoint_statistics_with_subtask_details = cls(
        ...
        task_checkpoint_statistics_with_subtask_details.additional_properties = d
        return task_checkpoint_statistics_with_subtask_details
