...
T = TypeVar("T", bound="SubtaskExecutionAttemptAccumulatorsInfo")
...
class SubtaskExecutionAttemptAccumulatorsInfo:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        subtask_execution_attempt_accumulators_info = cls(
            attempt=attempt,
            id=id,
            subtask=subtask,
        ...
        subtask_execution_attempt_accumulators_info.additional_properties = d
        return subtask_execution_attempt_accumulators_info
