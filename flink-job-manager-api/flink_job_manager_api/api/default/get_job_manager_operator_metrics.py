...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/jobs/{jobid}/vertices/{vertexid}/jm-operator-metrics",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Provides access to jobmanager operator metrics. This is an operator that executes on the jobmanager
    and the coordinator for FLIP 27 sources is one example of such an operator.
